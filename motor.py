...
try:
    for i in range(0,portion):
        p.ChangeDutyCycle(2.5)   #Enviamos un pulso del 3.75% para girar el servo hacia la izquierda
        time.sleep(1.5)           #pausa de medio segundo
        p.ChangeDutyCycle(6.9)   #Enviamos un pulso del 2.5% para girar el servo hacia la derecha
        time.sleep(1.5)
